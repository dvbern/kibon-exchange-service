...
INSERT INTO gemeinde (sequenceid, gemeindeuuid, name, bfsnummer, betreuungsgutscheineanbietenab, gueltigbis, mandant, angebotbg, angebotts, angebotfi)
VALUES (1, 'ea02b313-e7c3-4b26-9ef7-e413f4046db2', 'Paris', 99998, '2016-01-01', '9999-12-31', 'BERN', TRUE, TRUE, FALSE);

INSERT INTO gemeindekennzahlen (sequenceid, gemeindeuuid, bfsnummer, gesuchsperiodestart, gesuchsperiodestop, kontingentierung, kontingentierungausgeschoepft, anzahlkinderwarteliste, dauerwarteliste, erwerbspensumzuschlag, limitierungtfo, limitierungkita, mandant)
